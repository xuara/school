...
public class ArrayIndexedList<T> extends ArrayUnsortedList<T>
    ...
    public void add(int index, T element) // Throws IndexOutOfBoundsException if passed an index argument
    ...
    public T set(int index, T element) // Throws IndexOutOfBoundsException if passed an index argument
    // such that index < 0 or index >= size().
    ...
    public T get(int index) // Throws IndexOutOfBoundsException if passed an index argument
    // such that index < 0 or index >= size().
    ...
    public int indexOf(T element) // If this list contains an element e such that e.equals(element), 
    ...
    public T remove(int index) // Throws IndexOutOfBoundsException if passed an index argument
    // such that index < 0 or index >= size().
