...
public class Sorts {
    ...
    static int compsCount = 0;

    static final int SIZE = 50;            // size of array to be sorted
    static int[] values = new int[SIZE];   // values to be sorted

    static void initValues() // Initializes the values array with random integers from 0 to 99.
    {
    ...
    static public void swap(int index1, int index2) // Precondition: index1 and index2 are >= 0 and < SIZE.
    //
    ...
    //
    //  Selection Sort
    static int minIndex(int startIndex, int endIndex) // Returns the index of the smallest value in
    ...
    static void selectionSort() // Sorts the values array using the selection sort algorithm.
    {
        int endIndex = SIZE - 1;
    ...
    //
    //  Bubble Sort
    static void bubbleUp(int startIndex, int endIndex) // Switches adjacent pairs that are out of order 
    ...
    static void bubbleSort() // Sorts the values array using the bubble sort algorithm.
    {
        int current = 0;
    ...
    //
    //  Short Bubble Sort
    static boolean bubbleUp2(int startIndex, int endIndex) // Switches adjacent pairs that are out of order 
    // between values[startIndex]..values[endIndex] 
    // beginning at values[endIndex].
    //
    ...
    static void shortBubble() // Sorts the values array using the bubble sort algorithm.
    ...
    //
    //  Merge Sort
    static void merge(int leftFirst, int leftLast, int rightFirst, int rightLast) // Preconditions: values[leftFirst]..values[leftLast] are sorted.
    ...
    static void mergeSort(int first, int last) // Sorts the values array using the merge sort algorithm.
    {
        if (first < last) {
    ...
    //
    //  Heap Sort
    static int newHole(int hole, int lastIndex, int item) // If either child of hole is larger than item this returns the index
    // of the larger child; otherwise it returns the index of hole.
    {
        ...
        } else if (left == lastIndex) // hole has left child only
        {
         ...
         if (values[left] < values[right]) // left child < right child
            {
                compsCount++;
    ...
    static void reheapDown(int item, int root, int lastIndex) // Precondition: Current root position is "empty".
    //
    ...
    static void heapSort() // Sorts the values array using the heap sort algorithm.
    {
        int index;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Number of comparisons: " + compsCount + "\n");
    }
}
