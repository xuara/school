...
public class Heap<T extends Comparable<T>> implements PriQueueInterface<T> {
    ...
    public boolean isFull() // Returns true if this priority queue is full; otherwise, returns false.
    {
        return (lastIndex == maxIndex);
    }

    private void reheapUp(T element) // Current lastIndex position is empty.
    ...
    public void enqueue(T element) throws PriQOverflowException // Throws PriQOverflowException if this priority queue is full;
    ...
    private int newHole(int hole, T element) // If either child of hole is larger than element, return the index
    ...
    private void reheapDown(T element) // Current root position is "empty";
    // Inserts element into the tree and ensures shape and order properties.
    {
    ...
    public T dequeue() throws PriQUnderflowException // Throws PriQUnderflowException if this priority queue is empty;
